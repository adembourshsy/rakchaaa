...
const EMOJI_AUDIO_URLS: Record<string, string> = {
  ...
  'kiss_pop': 'https://www.myinstants.com/media/sounds/smoochykiss.mp3',
  ...
  'royal_fanfare': 'https://www.myinstants.com/media/sounds/fanfare-trumpet.mp3',
...
`;
fs.writeFileSync('src/services/emojiSoundService.ts', content);
